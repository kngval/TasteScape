...
exports.deleteCreatedRecipe = exports.getCreatedRecipeDetails = exports.fetchCreatedRecipeDetails = exports.createRecipe = exports.fetchCreatedRecipes = void 0;
...
const createRecipe = async (req, res) => {
    const { title, description, cuisineType, image, cookingTime, servings, healthScore, ingredients, instructions, nutrients, } = req.body;
    const userId = req.user;
    console.log(userId);
    try {
        const db = (0, db_1.getDb)();
