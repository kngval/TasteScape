      ...
      <div className="md:text-md xl:text-lg  p-4 shadow-md  rounded-lg">
       ...
       <div className="" >
        ...
        <div className="foodName flex justify-between items-center mt-2 ">
          ...
          <svg onClick={() => handleClick()} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={0.5} stroke="currentColor" className="ml-2 w-5 h-5 stroke-1 hover:fill-customPink hover:stroke-0">
