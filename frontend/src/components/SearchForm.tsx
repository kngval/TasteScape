...
const SearchForm = () => {
  ...
  return (
    <form onSubmit={handleSearch} className="w-full lg:w-1/2  flex justify-center items-center text-xs">

       
        <input type="text" value={search} className="w-40 lg:w-full h-8 p-4 rounded-s-full bg-gray-200 outline-none" placeholder="Search for A Recipe..." onChange={(e) => setSearch(e.target.value)}/>
